...
export default function App() {
  ...
  const cards = [
    {
      ...
      content:
        "O que temos de bom nessa sala, pessoal? Bora falar de programação, criação de coisas legais e projetos pessoais.",
    },
    {
      title: "gente-maneira-discutindo-tema-maneiro",
      content: "Um Nome • 70 pessoas",
    },
    ...
    {
      title: "Manda um nome maneiro para esse 4um",
      content: "Um Nome • 40 pessoas",
    },
  ...
  // when user is logged, render the login dashboard variant
